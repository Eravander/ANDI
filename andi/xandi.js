...
function init_module(){
    ...
    xANDI.analyze = function(){
        
        xANDI.accesskeys = new AndiAccesskeys();
        ...
        $(TestPageData.allVisibleElements).each(function(){
            ...
            if($(this).is(":focusable,canvas")){//If element is focusable, search for accessibility components.
                ...
                if(andiData.accesskey)
                    xANDI.accesskeys.push(this, andiData.accesskey, andiData.andiElementIndex);
    ...
    function AndiAccesskeys(){
        ...
        this.push = function(element, accesskey, index){
            if(accesskey){
                ...
                // xandi removed    andiAlerter.throwAlert(alert_0052,[accesskey]);
                    ...
                    if(duplicateComparator.includes(accesskey)){
                        ...
                        // xandi removed    andiAlerter.throwAlert(alert_0054,[accesskey]);
                            addToList(accesskey, alert_0054);
                        }
                        else if($(element).is("a[href]")){
                            //duplicate accesskey found on link
                        // xandi removed    andiAlerter.throwAlert(alert_0056,[accesskey]);
                            addToList(accesskey, alert_0056);
                        }
                        else{
                            //duplicate accesskey found
                        // xandi removed    andiAlerter.throwAlert(alert_0055,[accesskey]);
    ...
    xANDI.results = function(){
    console.log(testPageData);
