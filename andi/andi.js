...
// res = function() {
	...
	//==============//
	//URLs
	var host_url = "https://danieljudsonblair.github.io/ANDI/andi/";
	...
	function andiReady() {
		...
		function insertAndiBarHtml() {
			...
			var andiBar = "<section id='ANDI508' tabindex='-1' aria-label='ANDI' style='display:none'>" +
				...
				"<h5 id='ANDI508-toolName-heading'><a id='ANDI508-toolName-link' class='ANDI508-sectionJump' href='#' aria-haspopup='dialog' aria-label='ANDI " + andiVersionNumber + "'><span id='ANDI508-module-name' data-andi508-moduleversion=''>&nbsp;</span>LIEUTENANT</br><span> </span> DANDI</a></h5>" +
